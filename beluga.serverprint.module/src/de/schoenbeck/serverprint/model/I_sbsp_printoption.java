...
/** Generated Interface for sbsp_printoption
 *  @author iDempiere (generated) 
 *  @version Release 9
 */
@SuppressWarnings("all")
public interface I_sbsp_printoption 
{

    /** TableName=sbsp_printoption */
    public static final String Table_Name = "sbsp_printoption";
    ...
    /** Column name IsLimitedToProcess */
    public static final String COLUMNNAME_IsLimitedToProcess = "IsLimitedToProcess";

	/** Set Is limited to process calls.
	  * This option will not be shown to users and can only be called explicitly from code.
	  */
    ...
    /** Column name sbsp_printoption_UU */
    public static final String COLUMNNAME_sbsp_printoption_UU = "sbsp_printoption_UU";
